...
# Check if secrets are available (for Streamlit Cloud) without triggering errors
try:
...
try:
    authenticator = stauth.Authenticate(
        ...
        auto_hash=False  # Passwords are already hashed in config.yaml
    )
...
# Authentication
# In streamlit-authenticator 0.4.2, authentication status is stored in st.session_state
...
# Custom CSS with enhanced glassmorphism effect and gray shadows
st.markdown("""
    <style>
        /* Global light gray background */
        .main {
        ...
        /* Center align title with better visibility */
        h1 {
            text-align: center;
            color: #2a2a2a;
        ...
        /* Subheader styling with better contrast */
        h2, h3 {
            color: #333333;
            font-weight: 500;
        ...
        /* Result box styling with enhanced glassmorphism */
        .result-box {
        ...
        /* Button styling with enhanced glassmorphism */
        .stButton > button {
            width: 100%;
        ...
        /* Input field styling with enhanced glassmorphism */
        .stNumberInput > div > div > input,
        ...
        /* Expander styling with glassmorphism */
